 ...
 * - En el futuro: obtener entradas de cine del usuario
 */
export async function POST(request) {
  try {
    // Obtener la sesion de Auth0
    console.log("[SYNC] Obteniendo sesion de usuario desde /api/v1/sync...");
    ...
    // TODO: Aqui se podrian obtener las entradas de cine del usuario
