...
const Header = () => {
  ...
  // Clases reutilizables para los enlaces de navegacion
    ...
    <header className={clsx(
      ...
      <div className="flex flex-wrap justify-between items-center max-w-7xl mx-auto gap-4">
        ...
        <nav className="flex gap-2 items-center">
          <Link href={`/cartelera/${city}`} prefetch={false} className={navLinkClasses}>
            Inicio
          </Link>
          <Link href="/about" prefetch={false} className={navLinkClasses}>
            Nosotros
          </Link>
          {user && user.role === 'admin' && (
            <Link href="/admin" prefetch={false} className={navLinkClasses}>
              Admin
            </Link>
          )}
        </nav>
        ...
        <div className="flex gap-4 items-center">
          ...
          >
            {isUpdatingDates ? 'Actualizando...' : 'Sesiones Hoy'}
          </button>
          <button
