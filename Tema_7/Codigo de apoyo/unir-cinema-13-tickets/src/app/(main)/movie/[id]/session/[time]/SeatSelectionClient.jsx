...
// Client Component - Selección de asientos con interactividad y modal de pago
// Recibe los datos de la película ya cargados desde el Server Component
// - useState para manejar asientos seleccionados y modal
...
const SeatSelectionClient = ({ movie, time, screeningId, screeningPrice = 12 }) => {
        ...
        {selectedSeats.length > 0 && (
          <div className="text-center p-6 bg-cinema-dark-elevated rounded-xl border border-cinema-gold shadow-lg shadow-cinema-gold/20">
            ...
            <p className="text-cinema-text-muted text-lg mb-4">
              Total: {selectedSeats.length} asiento(s) × {screeningPrice}€ = <strong className="text-cinema-gold text-xl">{totalPrice.toFixed(2)}€</strong>
            </p>
            <button
            ...
            {!screeningId && (
              <p className="text-red-400 text-sm mt-2">
                No se encontró la sesión. Vuelve a la cartelera e intenta de nuevo.
              </p>
            )}
          </div>
        )}
              ...
              <>
                ...
                <form onSubmit={handlePaymentSubmit} className="space-y-4">
                  ...
                  <div className="bg-cinema-dark-elevated p-4 rounded-lg border border-cinema-border mb-6">
                    <p className="text-cinema-text-muted text-sm">Película</p>
                    <p className="text-cinema-text font-semibold">{movie.title}</p>
                    <p className="text-cinema-text-muted text-sm mt-2">Asientos</p>
                    <p className="text-cinema-gold font-semibold">{selectedSeats.join(', ')}</p>
                    <p className="text-cinema-text-muted text-sm mt-2">Total</p>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={clsx(
                        ...
                        "text-cinema-text placeholder-cinema-text-muted",
                        "focus:border-cinema-gold focus:outline-none"
                      )}
                  ...
                  <div className="flex gap-4 mt-6">
                    <button
                      ...
                      className={clsx(
                        ...
                        "bg-cinema-dark-elevated border border-cinema-border text-cinema-text-muted",
                        "hover:text-cinema-text hover:border-cinema-text-muted",
                  ...
                  {/* Aviso de prueba */}
                  <p className="text-cinema-text-muted text-xs text-center mt-4">
                    🔒 Los datos están precargados para facilitar las pruebas.
                    <br />
