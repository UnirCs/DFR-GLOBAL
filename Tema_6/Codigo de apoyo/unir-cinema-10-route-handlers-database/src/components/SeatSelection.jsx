    ...
    return (
      <div className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full">
        <div className="bg-gradient-to-br from-cinema-dark-card to-cinema-dark-elevated p-8 rounded-2xl shadow-lg border border-cinema-border text-center">
          ...
          <Link href="/Tema_5/Codigo%20de%20apoyo/unir-cinema-08-ssg-isr/public" className="inline-block bg-gradient-to-r from-cinema-gold to-cinema-gold-dark text-cinema-dark px-6 py-3 rounded-lg font-bold hover:brightness-110 transition-all">
            Volver al inicio
          </Link>
        </div>
      </div>
