    ...
    <div className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full">
      <div className="bg-gradient-to-br from-cinema-dark-card to-cinema-dark-elevated p-6 md:p-8 rounded-2xl shadow-lg border border-cinema-border">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          {/* Poster */}
          <div className="relative w-full md:w-[300px] md:min-w-[300px] h-[400px] md:h-[450px] rounded-xl overflow-hidden shadow-lg border-2 border-cinema-border flex-shrink-0">
            <Image
              src="/film-poster.jpg"
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
              {[
                ...
                <div key={item.label} className="bg-cinema-dark-elevated p-3 rounded-lg text-center border border-cinema-border hover:border-cinema-gold transition-colors">
          ...
          <div className="flex flex-wrap gap-3">
            {movie.showtimes.map((time, index) => (
              <Link
                ...
                className={`${styles.sessionLink} px-5 py-2 bg-gradient-to-r from-cinema-red to-cinema-red-dark text-white rounded-full font-semibold shadow-lg shadow-cinema-red/30 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-cinema-red/50 hover:brightness-110 transition-all duration-300`}
              >
                {time}
              </Link>
            ))}
