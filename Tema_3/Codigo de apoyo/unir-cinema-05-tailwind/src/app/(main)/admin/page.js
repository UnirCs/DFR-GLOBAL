  ...
  return (
    <PrivateRoute>
      <div className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full">
        <div className="bg-gradient-to-br from-cinema-dark-card to-cinema-dark-elevated p-8 rounded-2xl shadow-lg border border-cinema-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-cinema-dark-elevated p-5 rounded-xl text-center border border-cinema-border hover:border-cinema-gold hover:-translate-y-1 transition-all duration-300 hover:shadow-lg hover:shadow-cinema-gold/20"
              >
